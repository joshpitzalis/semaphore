...
function Home() {
  ...
  useEffect(() => {
    generateRandomWord().then(({ word }) => setName(word));
  }, []);
        ...
        <div>
          ...
          <div className="flex gap-2 mb-2">
            <input
              ...
              className="flex-1 min-w-0 rounded-lg border border-ink/10 bg-white px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-accent/30"
